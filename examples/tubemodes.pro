...
if n_params(0) lt 1 then begin
   print,'tubemodes, rho_int=ro, rho_ext=re, valfv_int=va, valv_ext=vae, cs_int=co, cs_ext=ce, bo_int=bo, be_ext=be, waka_ini=waka_ini, waka_root, ka_root, nmode = nmode, normcase = normcase'
   return
endif
...
for j=0,nka-1 do begin
   ...
   while(dwa1 gt 1.e-1) do begin
      stepg = 0.001
      wa = wa0*(1.-stepg*k)
      wa_2 = (wa0*(1.-stepg*k)-0.05*ka)>(va*1.01*ka)
...
plot,ka_root,waka_root,/xs,/ys,psym=3,yr=[va-va/5,vae+vae/5.],xr=[0,4]
