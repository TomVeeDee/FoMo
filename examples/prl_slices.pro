  ...
  for i=0,nfiles-1 do begin
     ...
     if (file_test(checkfile) eq 0) then begin
        ...
        if imaging eq 1 then begin
           ...
           lineongrid_goft_tab, rho, te, wave=wave,nwave=nwave,minwave=minwave,maxwave=maxwave,ion=ion, w0=w0, emission_goft=emission_goft,logt=logt,wayemi=wayemi, watom=watom
        endelse
