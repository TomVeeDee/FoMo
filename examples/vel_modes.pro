...
if reg1[0] ne -1 then begin
   sigi[reg1] = 1.
   sigk[reg1] = 1.
   aa1[reg1] = aa0[reg1]*beseli(sqrt(sigi[reg1]*moa2[reg1]),n,/double)/beselk(sqrt(sigk[reg1]*mea2[reg1]),n,/double)*(co^2+va^2)*(waka_root[reg1]^2-ct^2)/((ce^2+vae^2)*(waka_root[reg1]^2-cte^2))*ro/re
   for i=0,nlocin-1 do begin
      mor2[reg1,locin[i]] = moa2[reg1]*(gridr[locin[i]]/aa)^2
      vr_md[reg1,locin[i]] = (va^2+co^2)*(waka_root[reg1]^2-ct^2)/(waka_root[reg1]^2*(waka_root[reg1]^2-va^2))*aa0[reg1]*sqrt(sigi[reg1]*moa2[reg1]/aa^2)*dbeseli(sqrt(sigi[reg1]*mor2[reg1,locin[i]]),n)*(aa/ka_root[reg1])^2
      if gridr[locin[i]] eq 0 then begin         
         vt_md[reg1,locin[i]] = -(va^2+co^2-va^2*co^2/waka_root[reg1]^2)*aa0[reg1]*n*1./((waka_root[reg1]*ka_root[reg1])^2-va^2*ka_root[reg1]^2)*aa^2*(1./gamma(n+1)*(sqrt(sigi[reg1]*moa2[reg1]/aa)*0.5)^n)
      endif else begin
         vt_md[reg1,locin[i]] = -(va^2+co^2-va^2*co^2/waka_root[reg1]^2)*aa0[reg1]*n*beseli(sqrt(sigi[reg1]*mor2[reg1,locin[i]]),n,/double)/((waka_root[reg1]*ka_root[reg1])^2-va^2*ka_root[reg1]^2)/gridr[locin[i]]*aa^2
      endelse
...
if reg2[0] ne -1 then begin
   sigi[reg2] = 1.
   sigk[reg2] = -1.
   aa1[reg2] = aa0[reg2]*beseli(sqrt(sigi[reg2]*moa2[reg2]),n,/double)/besely(sqrt(sigk[reg2]*mea2[reg2]),n,/double)*(co^2+va^2)*(waka_root[reg2]^2-ct^2)/((ce^2+vae^2)*(waka_root[reg2]^2-cte^2))*ro/re
   for i=0,nlocin-1 do begin
      mor2[reg2,locin[i]] = moa2[reg2]*(gridr[locin[i]]/aa)^2
      vr_md[reg2,locin[i]] = (va^2+co^2)*(waka_root[reg2]^2-ct^2)/(waka_root[reg2]^2*(waka_root[reg2]^2-va^2))*aa0[reg2]*sqrt(sigi[reg2]*moa2[reg2]/aa^2)*dbeseli(sqrt(sigi[reg2]*mor2[reg2,locin[i]]),n)*(aa/ka_root[reg2])^2
      if gridr[locin[i]] eq 0 then begin         
         vt_md[reg2,locin[i]] = -(va^2+co^2-va^2*co^2/waka_root[reg2]^2)*aa0[reg2]*n*1./((waka_root[reg2]*ka_root[reg2])^2-va^2*ka_root[reg2]^2)*aa^2*(1./gamma(n+1)*(sqrt(sigi[reg2]*moa2[reg2]/aa)*0.5)^n)
      endif else begin
         vt_md[reg2,locin[i]] = -(va^2+co^2-va^2*co^2/waka_root[reg2]^2)*aa0[reg2]*n*beseli(sqrt(sigi[reg2]*mor2[reg2,locin[i]]),n,/double)/((waka_root[reg2]*ka_root[reg2])^2-va^2*ka_root[reg2]^2)/gridr[locin[i]]*aa^2
      endelse
...
if reg3[0] ne -1 then begin
   sigi[reg3] = -1.
   sigk[reg3] = 1.
;   aa1[reg3] = aa0[reg3]*beselj(sqrt(sigi[reg3]*moa2[reg3]/aa^2*gridr[locin[-1]]^2),n,/double)/beselk(sqrt(sigk[reg3]*mea2[reg3]/aa^2*gridr[locout[0]]^2),n,/double)*(co^2+va^2)*(waka_root[reg3]^2-ct^2)/((ce^2+vae^2)*(waka_root[reg3]^2-cte^2))*ro/re
   aa1[reg3] = aa0[reg3]*beselj(sqrt(sigi[reg3]*moa2[reg3]),n,/double)/beselk(sqrt(sigk[reg3]*mea2[reg3]),n,/double)*(co^2+va^2)*(waka_root[reg3]^2-ct^2)/((ce^2+vae^2)*(waka_root[reg3]^2-cte^2))*ro/re
   for i=0,nlocin-1 do begin
      mor2[reg3,locin[i]] = moa2[reg3]*(gridr[locin[i]]/aa)^2
      vr_md[reg3,locin[i]] = (va^2+co^2)*(waka_root[reg3]^2-ct^2)/(waka_root[reg3]^2*(waka_root[reg3]^2-va^2))*aa0[reg3]*sqrt(sigi[reg3]*moa2[reg3]/aa^2)*dbeselj(sqrt(sigi[reg3]*mor2[reg3,locin[i]]),n)*(aa/ka_root[reg3])^2
      if gridr[locin[i]] eq 0 then begin         
         if n gt 0 then vt_md[reg3,locin[i]] = -(va^2+co^2-va^2*co^2/waka_root[reg3]^2)*aa0[reg3]*n*1./((waka_root[reg3]*ka_root[reg3])^2-va^2*ka_root[reg3]^2)*aa^2*1./gamma(n+1)*(sqrt(sigi[reg3]*moa2[reg3]/aa^2)*0.5)^n*(gridr[locin[i]])^(n-1) else vt_md[reg3,locin[i]] = 0.
      endif else begin
         vt_md[reg3,locin[i]] = -(va^2+co^2-va^2*co^2/waka_root[reg3]^2)*aa0[reg3]*n*beselj(sqrt(sigi[reg3]*mor2[reg3,locin[i]]),n,/double)/((waka_root[reg3]*ka_root[reg3])^2-va^2*ka_root[reg3]^2)/gridr[locin[i]]*aa^2
      endelse
...
if reg4[0] ne -1 then begin
   sigi[reg4] = -1.
   sigk[reg4] = -1.
   aa1[reg4] = aa0[reg4]*beselj(sqrt(sigi[reg4]*moa2[reg4]),n,/double)/besely(sqrt(sigk[reg4]*mea2[reg4]),n,/double)*(co^2+va^2)*(waka_root[reg4]^2-ct^2)/((ce^2+vae^2)*(waka_root[reg4]^2-cte^2))*ro/re
   for i=0,nlocin-1 do begin
      mor2[reg4,locin[i]] = moa2[reg4]*(gridr[locin[i]]/aa)^2
      vr_md[reg4,locin[i]] = (va^2+co^2)*(waka_root[reg4]^2-ct^2)/(waka_root[reg4]^2*(waka_root[reg4]^2-va^2))*aa0[reg4]*sqrt(sigi[reg4]*moa2[reg4]/aa^2)*dbeselj(sqrt(sigi[reg4]*mor2[reg4,locin[i]]),n)*(aa/ka_root[reg4])^2
      if gridr[locin[i]] eq 0 then begin         
         vt_md[reg4,locin[i]] = -(va^2+co^2-va^2*co^2/waka_root[reg4]^2)*aa0[reg4]*n*1./((waka_root[reg4]*ka_root[reg4])^2-va^2*ka_root[reg4]^2)*aa^2*(1./gamma(n+1)*(sqrt(sigi[reg4]*moa2[reg4]/aa)*0.5)^n)
      endif else begin
         vt_md[reg4,locin[i]] = -(va^2+co^2-va^2*co^2/waka_root[reg4]^2)*aa0[reg4]*n*beselj(sqrt(sigi[reg4]*mor2[reg4,locin[i]]),n,/double)/((waka_root[reg4]*ka_root[reg4])^2-va^2*ka_root[reg4]^2)/gridr[locin[i]]*aa^2
      endelse
