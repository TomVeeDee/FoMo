...
int main(int argc, char* argv[])
{
	...
	desc.add_options()
		...
		("par,p", po::value<string>(&parstring)->default_value("amrvac.par"),"name and location of amrvac.par file, only needed for older (i.e. pre-2017) AMRVAC snapshots")
		("version,V", po::value<string>(&amrvac_version)->default_value("gitlab"), "set amrvac version (gitlab or old), only needed for older (i.e. pre-2017) AMRVAC snapshots")
