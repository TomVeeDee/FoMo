...
pro readimgcubes, set, co,ce,ro,re,va,vae,aa,dimt,tarr,r0,ka_rt,wk_rt,wave, gridx, gridy, gridz,gridz_ext, imgcube00d,imgcube30d,imgcube45d,imgcube60d

if n_params(0) lt 1 then begin
   print,'readimgcubes, set, co,ce,ro,re,va,vae,aa,dimt,tarr,r0,ka_rt,wk_rt,wave, gridx, gridy, gridz,gridz_ext, imgcube00d,imgcube30d,imgcube45d,imgcube60d'
   return
endif
