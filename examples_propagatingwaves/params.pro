...
if set eq 2 then begin dir = '/users/cpa/sgijsen/FoMo/examples_propagating/Run_t41_propsauP2L15/' & kanm = 'ka2.24' & endif
if set eq 24 then begin dir = '/users/cpa/sgijsen/FoMo/examples_propagating/Run_t41_propsauP2L15/' & kanm = 'ka2.24_hgres' & endif
if set eq 21 then begin dir = '/users/cpa/sgijsen/FoMo/examples_propagating/Run_t41_propsauP2L15/' & kanm = 'ka2.24_highT' & endif
if set eq 22 then begin dir = '/users/cpa/sgijsen/FoMo/examples_propagating/Run_t41_propsauP2L15/' & kanm = 'ka2.24_sm' & endif
if set eq 25 then begin dir = '/users/cpa/sgijsen/FoMo/examples_propagating/Run_t41_propsauP2L15/' & kanm = 'ka2.24_hgres2d' & endif
if set eq 3 then begin dir = '/users/cpa/sgijsen/FoMo/examples_propagating/Run_t41_propsauP2L15/' & kanm = 'ka1.25' & endif
...
if set ne 25 then begin
   ...
   if set ne 24 then begin
      restore, dir+'slice_all_'+kanm+'_'+string(it,format='(i3.3)')+'t_'+string(ix,format='(i3.3)')+'x'+'.sav'
   endif else begin
