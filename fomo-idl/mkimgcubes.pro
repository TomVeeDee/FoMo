...
pro mkimgcubes, set=set, gridx=gridx, dimt=dimt, dim00d=dim00d, dim30d=dim30d, dim45d=dim45d, dim60d=dim60d, gridy, gridz_ext, wave, imgcube00d,imgcube30d,imgcube45d,imgcube60d,imaging=imaging
...
if set eq 24 then begin dir = '/users/cpa/pantolin/Modeling/cubes/set2/' & ka_n = '_ka2.24_hgres_fe9' & sln = 6 & endif
...
if imaging eq 0 then imgcube00d = fltarr(dimx,dim00d,nwave,dimt) else imgcube00d = fltarr(dimx,dim00d,dimt)
if set ne 25 and set ne 26 and set ne 24 then begin
